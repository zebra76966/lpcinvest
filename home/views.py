...
def common(request):
    ...
    feature_data['recent_properties'] = Properties.objects.all().order_by('-pub_date')[:4]
...
def home_page(request):
    ...
    return render(request,'user/index.html',{"properties":cleaned_properties})
...
def team_meber_view(request,name):

    return render(request,'user/team_member_view.html')
